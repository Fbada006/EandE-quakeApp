...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Quakedetails> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Quakedetails earthquake = new Quakedetails(magnitude, location, time);
            ...
            Log.e("Query Utils======", "Problem parsing the earthquake JSON results====================================", e);
        }
